...
# Create a markdown link that looks like a button
    link = f'<a href="{url}" target="_blank"><button style="display: inline-block; background-color: #00EEFF; color: white; border: none; padding: 10px 20px; text-align: center; text-decoration: none; font-size: 16px; cursor: pointer; border-radius: 5px;">🎁 Donate</button></a>'
